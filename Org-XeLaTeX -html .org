...
#+html_link_home:
#+html_link_up:
#+html_mathjax:<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=TeX-MML-AM_CHTML' async></script>
...
#+html_head_extra:
#+subtitle: [[file:Org-XeLaTeX.pdf][PDF版本下载]]
#+infojs_opt:
...
希望能够帮助大家完成自己的
毕业论文。
笔者默认你使用 @@html:<i class="fab fa-windows"></i>@@  Windows10操作系统，
